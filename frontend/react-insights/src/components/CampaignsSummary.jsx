  ...
  return (
    <div className="bg-white rounded-xl border border-border p-5 shadow-card">
      <div className="flex items-center mb-4">
        ...
        <InfoTooltip text="Totais de campanhas de comunicacao ativa disparadas e assessores alcancados no periodo selecionado." />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm font-medium text-green-700">Assessores Alcancados</span>
          </div>
